    ...
    return (
        <div className="bg-blue-100 h-[90vh] w-1/4 p-4 pr-0">
            <ul>
                ...
                <p className='uppercase text-blue-700 pt-5 pb-2 font-medium'>Available Doctors</p>
                <li className={`cursor-pointer text-lg px-4 py-1.5 rounded-l-lg ${activeTab === 'Doctors' ? "bg-blue-700 text-white" : "text-blue-7-00 "}`} onClick={() => setActiveTab('Doctors')}>
                    Doctors
                </li>
            </ul>
        </div>
